...
TEST_CASE("Test epochs copy") {
  cluon::In_Ranges<uint64_t> tmpIR;
  tmpIR.addRange(std::make_pair(1608099630322516000, 1608104277224115000));
  tmpIR.addRange(std::make_pair(1608108723409431000, 1608111802194196000));
  tmpIR.addRange(std::make_pair(1608116930379220000, 1608120077139878000));
  tmpIR.addRange(std::make_pair(1608178024311792000, 1608181062148791000));

  cluon::In_Ranges<uint64_t> IR(tmpIR);
