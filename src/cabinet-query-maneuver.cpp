...
int32_t identifyManeuversSFC(char **argv, const std::string CABINET, const uint64_t MEM, const bool VERBOSE, const uint64_t THR, const bool APLX, std::vector<std::string> geoboxStrings, std::pair<float,float> geoboxBL, std::pair<float,float> geoboxTR, std::vector<DrivingStatus*> maneuver) {
  int32_t retCode{0};
...
////////////////////////////////////////////////////////////////////////////////
    ...
    retCode = identifyManeuversSFC(argv, CABINET, MEM, VERBOSE, THR, APLX, geoboxStrings, geoboxBL, geoboxTR, maneuver);
  }
  return retCode;
}