...
int32_t main(int32_t argc, char **argv) {
  ...
  if (0 == commandlineArguments.count("cab")) {
    ...
    std::vector<std::pair<int64_t, int64_t>> detectionBF = cabinet_queryManeuverBruteForcePrimitive(MEM, CABINET, APLX, VERBOSE, _fenceBL, _fenceTR, drivingstatus, 0, 0, entryCNT);
    if(VERBOSE) {
